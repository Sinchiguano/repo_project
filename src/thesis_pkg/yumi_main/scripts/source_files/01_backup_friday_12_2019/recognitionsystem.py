...
def do_vector3d(pc):
    ...
    # #i took rotation from my bridge then translation from the robot calibration
    # pcd.transform([[-0.02422879,  0.63563132, -0.77161246,  1.20563195],
    #                 [ 0.99967252,  0.00904692, -0.02393734, 0.11559001],
    #                 [-0.00823461, -0.77193975, -0.63564237,  0.90*(0.55303995)],
    #                 [ 0.,          0.,          0.,          1.,        ]])
    #Correction                  
