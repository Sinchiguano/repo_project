...
if("TRUE" STREQUAL "TRUE")
  set(target_finder_SOURCE_PREFIX /home/casch/yumi_depends_ws/src/extrinsic_Industrial/industrial_calibration/target_finder)
  set(target_finder_DEVEL_PREFIX /home/casch/yumi_depends_ws/devel)
  ...
  set(target_finder_INSTALL_PREFIX /home/casch/yumi_depends_ws/install)
...
if(NOT "/home/casch/yumi_depends_ws/devel/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'target_finder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_depends_ws/src/extrinsic_Industrial/industrial_calibration/target_finder/${idir}'.  ${_report}")
    endif()
