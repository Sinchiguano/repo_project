...
if(NOT "/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rgbd_depth_correction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_depends_ws/src/extrinsic_Industrial/industrial_calibration/rgbd_depth_correction/${idir}'.  ${_report}")
    endif()
