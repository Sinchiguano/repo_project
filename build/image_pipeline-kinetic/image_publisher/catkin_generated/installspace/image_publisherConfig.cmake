...
if("FALSE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/casch/yumi_depends_ws/src/image_pipeline-kinetic/image_publisher)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_depends_ws/install/${idir}'.  ${_report}")
    endif()
