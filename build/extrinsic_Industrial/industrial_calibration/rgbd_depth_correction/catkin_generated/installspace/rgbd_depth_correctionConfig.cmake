...
if("FALSE" STREQUAL "TRUE")
  set(rgbd_depth_correction_SOURCE_PREFIX /home/casch/yumi_depends_ws/src/extrinsic_Industrial/industrial_calibration/rgbd_depth_correction)
  set(rgbd_depth_correction_DEVEL_PREFIX /home/casch/yumi_depends_ws/devel)
  ...
  set(rgbd_depth_correction_INSTALL_PREFIX /home/casch/yumi_depends_ws/install)
...
if(NOT "/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rgbd_depth_correction' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_depends_ws/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/casch/yumi_depends_ws/install/lib;/home/casch/yumi_depends_ws/devel/lib;/opt/ros/kinetic/lib)
