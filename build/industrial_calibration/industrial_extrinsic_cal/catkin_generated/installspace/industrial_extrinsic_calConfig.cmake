...
if("FALSE" STREQUAL "TRUE")
  set(industrial_extrinsic_cal_SOURCE_PREFIX /home/casch/yumi_depends_ws/src/industrial_calibration/industrial_extrinsic_cal)
...
if(NOT "include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/casch/yumi_depends_ws/install/${idir}'.  ${_report}")
    endif()
