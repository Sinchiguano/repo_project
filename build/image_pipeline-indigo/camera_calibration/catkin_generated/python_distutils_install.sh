...
echo_and_run cd "/home/casch/yumi_depends_ws/src/image_pipeline-indigo/camera_calibration"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/casch/yumi_depends_ws/src/image_pipeline-indigo/camera_calibration/setup.py" \
    build --build-base "/home/casch/yumi_depends_ws/build/image_pipeline-indigo/camera_calibration" \
    install \
    $DESTDIR_ARG \
